...
export enum EOperatorsActions {
  ...
  SURVEY_DELETE = 7,
  SURVEY_ACTIVE = 8,
  SURVEY_QUESTION_CREATE = 9,
  SURVEY_QUESTION_UPDATE = 10,
  SURVEY_QUESTION_DELETE = 11,
  SURVEY_QUESTION_ACTIVE = 12,
  SURVEY_QUESTION_MOVE = 13,
  SURVEY_QUESTION_ANSWER_CREATE = 14,
  SURVEY_QUESTION_ANSWER_UPDATE = 15,
  SURVEY_QUESTION_ANSWER_DELETE = 16,
  SURVEY_QUESTION_ANSWER_ACTIVE = 17,
  SURVEY_QUESTION_ANSWER_MOVE = 18,
  SURVEY_RISK_CALCULATION_CREATE = 19,
  SURVEY_RISK_CALCULATION_UPDATE = 20,
  SURVEY_RISK_CALCULATION_DELETE = 21,
  SURVEY_RISK_CALCULATION_MOVE = 22,
}
